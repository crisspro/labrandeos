...
OutputBaseFilename=Labrandeos v{#MyAppVersion} x64 installer
Compression=lzma
...
[Files]
Source: "C:\Users\criss\Desktop\proyectos python\Labrandeos\build\exe.win-amd64-3.12\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion sign
Source: "C:\Users\criss\Desktop\proyectos python\Labrandeos\build\exe.win-amd64-3.12\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
